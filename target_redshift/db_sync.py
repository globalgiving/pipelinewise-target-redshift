...
# Taken from https://github.com/transferwise/pipelinewise-target-redshift/pull/298/files
# which remains unmerged, even though this is needed for python 3.10 compatibilty
import sys
